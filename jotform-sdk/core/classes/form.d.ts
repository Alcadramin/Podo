...
interface IForm {
    ...
    getFormSubmissions(formId: string, offset?: number, limit?: number, filter?: object, orderby?: string, direction?: string, nocache?: string): Promise<object>;
    ...
    addOrEditQuestionProperty(formId: string, questionId: string, data: object): Promise<object>;
    createFormReport(formId: string, title: string, list_type: string, fields?: string): Promise<object>;
...
export declare class Form implements IForm {
     ...
     */
    getFormSubmissions: (formId: string, offset?: number | undefined, limit?: number | undefined, filter?: object | undefined, orderby?: string | undefined, direction?: string | undefined, nocache?: string | undefined) => Promise<object>;
    /**
