...
var User = /** @class */ (function () {
    function User(client) {
         ...
         */
        this.getSubmissions = function (offset, limit, filter, orderby, direction, nocache) {
            return _this.client.Request('GET', "/user/submissions?filter=" + (filter || '') + "&offset=" + (offset || '') + "&limit" + (limit || '') + "&orderby=" + (orderby || '') + "&nocache=" + (nocache || '') + "&direction=" + (direction || ''));
        };
        /**
