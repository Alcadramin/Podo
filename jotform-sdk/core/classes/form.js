...
var Form = /** @class */ (function () {
    function Form(client) {
         ...
         */
        this.getFormSubmissions = function (formId, offset, limit, filter, orderby, direction, nocache) {
            return _this.client.Request('GET', "/form/" + formId + "/submissions?filter=" + (filter || '') + "&offset=" + (offset || '') + "&limit" + (limit || '') + "&orderby=" + (orderby || '') + "&nocache=" + (nocache || '') + "&direction=" + (direction || ''));
        };
        /**
        ...
        this.getFormPropertyByKey = function (formId, key) {
            return _this.client.Request('GET', "/form/" + formId + "/properties/" + key);
        };
        /**
        ...
        this.createFormSubmissions = function (formId, data) {
            return _this.client.Request('PUT', "/form/" + formId + "/submissions", data);
        };
        /**
        ...
        this.createFormWebhook = function (formId, webhookURL) {
            ...
            return _this.client.Request('POST', "/form/" + formId + "/webhooks", params);
        };
        /**
        ...
        this.addNewQuestionToForm = function (formId, data) {
            return _this.client.Request('PUT', "/form/" + formId + "/questions", data);
        };
        /**
        ...
        this.addOrEditQuestionProperty = function (formId, questionId, data) {
            return _this.client.Request('POST', "/form/" + formId + "/question/" + questionId, data);
        };
        /**
        ...
        this.createFormReport = function (formId, title, list_type, fields) {
            ...
            return _this.client.Request('POST', "/form/" + formId + "/reports", params);
        };
        /**
         *
         * @param formId Form ID.
        ...
        this.createOrEditFormProperty = function (formId, data) {
            return _this.client.Request('PUT', "/form/" + formId + "/properties", data);
        };
        /**
        ...
        this.deleteFormQuestion = function (formId, questionId) {
            return _this.client.Request('DELETE', "/form/" + formId + "/question/" + questionId);
        };
        /**
        ...
        this.deleteFormWebhook = function (formId, webhookId) {
            return _this.client.Request('DELETE', "/form/" + formId + "/webhooks/" + webhookId);
        };
        this.client = client;
    }
    return Form;
