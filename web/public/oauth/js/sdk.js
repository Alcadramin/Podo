...
var JF = (function (base) {
  ...
  var _config = function (options) {
    ...
    if (
      ...
      typeof options.autocomplete === 'object'
    ) {
  ...
  root.getUser = function (callback, errback) {
    ...
    _xdr(
      _requestURL + '/user?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        self.user = resp;
  ...
  root.getUsage = function (callback, errback) {
    ...
    _xdr(
      _requestURL + '/user/usage?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        self.usage = resp;
  ...
  root.getSubUsers = function (callback, errback) {
    ...
    _xdr(
      _requestURL + '/user/subusers?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        self.subusers = resp;
  ...
  root.getFolders = function (callback, errback) {
    ...
    _xdr(
      _requestURL + '/user/folders?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        self.folders = resp;
  ...
  root.getReports = function (callback, errback) {
    ...
    _xdr(
      _requestURL + '/user/reports?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        self.reports = resp;
  ...
  root.getSettings = function (callback, errback) {
    ...
    _xdr(
      _requestURL + '/user/settings?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        self.settings = resp;
  ...
  root.createForm = function (formContent, callback, errback) {
    ...
    _xdr(
      _requestURL + '/user/forms?apiKey=' + _apiKey,
      'post',
      serialize(formContent),
      function (resp) {
        callback(resp);
      },
      errback
  ...
  root.getForm = function (formID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
  ...
  root.cloneForm = function (formID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '/clone?apiKey=' + _apiKey,
      'post',
      undefined,
      function (resp) {
        callback(resp);
  ...
  root.getFormQuestions = function (formID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '/questions?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
   ...
   * ----
   */
  root.editFormQuestion = function (
    formID,
    questionID,
    question,
    callback,
  ...
  root.getFormProperties = function (formID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '/properties?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
   ...
   * ----
   */
  root.setMultipleFormProperties = function (
    formID,
    properties,
    callback,
    errback
  ...
  root.getFormFiles = function (formID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '/files?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
  ...
  root.getFormWebhooks = function (formID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '/webhooks?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
  ...
  root.createFormSubmission = function (formID, submission, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '/submissions?apiKey=' + _apiKey,
      'post',
   ...
   * ------------------------------------------------------
   */
  root.createFormSubmissions = function (
    formID,
    submissions,
    callback,
    errback
  ...
  root.getSubmission = function (submissionID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/submission/' + submissionID + '?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
  ...
  root.getReport = function (reportID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/report/' + reportID + '?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
  ...
  root.createReport = function (formID, report, callback, errback) {
    ...
    _xdr(
      _requestURL + '/form/' + formID + '/reports?apiKey=' + _apiKey,
      'post',
      serialize(report),
      function (resp) {
        callback(resp);
  ...
  root.getFolder = function (folderID, callback, errback) {
    ...
    _xdr(
      _requestURL + '/folder/' + folderID + '?apiKey=' + _apiKey,
      'get',
      undefined,
      function (resp) {
        callback(resp);
  ...
  root.getPlan = function (planType, callback) {
    ...
    if (planType.match('http:')) {
      ...
      _xdr(
        _requestURL + '/system/plan/' + planType.toUpperCase(),
        'get',
        undefined,
        function (resp) {
          callback(resp);
  ...
  root.bindXD = function (_baseURL) {
    XD.receiveMessage(function (message) {
      ...
      if (typeof msg === 'string' && msg.match(/resizeFrame:(.*)/)) {
        ...
        document.getElementById('jotform_oauth_frame').style.height =
          frameHeight + 'px';
      }
    });
  };
  ...
  function _login(success, error, onCloseCallback, isGuest) {
    ...
    if (_autocomplete) {
      loginWindowParams.push(
        'autocomplete=' + encodeURIComponent(_autocomplete)
      );
    }
    if (_authType == 'signup') {
    ...
    frame.setAttribute(
      'src',
      _loginWindowURL + '?' + loginWindowParams.join('&')
    );
